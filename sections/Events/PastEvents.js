  ...
  return (
    <section className="py-14" id="events">
      <div className="container md:px-4 lg:px-0 flex flex-col justify-center items-center place-items-center h-full lg:justify-between">
        {/* Header */}
        <h1 className="text-black pb-10 text-center text-4xl lg:text-6xl xl:text-5xl">Past events</h1>
        ...
        <div className="flex flex-row flex-wrap gap-y-10 gap-x-10 text-center justify-center w-full">
          {concludedEvents.map((event, index) => {
            return (
              <div className="xl:w-5/12 w-full rounded-xl bg-white shadow-md" key={index}>
                <div className="flex md:flex-row flex-col items-center">
                  <div className="relative xl:w-10/12 md:w-2/5 md:h-full w-48 h-48 rounded-md shadow-md overflow-hidden">
                    {/* Event Image */}
                    <Image
                  ...
                  <div className="flex flex-col md:w-4/5 w-full h-64 mx-5 mt-5 md:text-left text-center">
                    ...
                    <p className="text-lg mb-2 overflow-ellipsis overflow-hidden line-clamp-3">
                      {event.description}
                    </p>
                    <a
                      href={event.lumaLink}
