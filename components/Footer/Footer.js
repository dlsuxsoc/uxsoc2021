...
import { FaDiscord, FaTwitter, FaInstagram, FaFacebookSquare } from "react-icons/fa";

const Footer = () => {
    return (
        <div className={`${styles.container} pt-32 pb-24 px-4 sm:px-32 flex flex-wrap lg:flex-nowrap`}>
            ...
            <div className="w-full lg:w-1/2">
                <ul className="list-none w-full flex flex-wrap justify-center lg:justify-end mb-16">
                    {data.map((item, index) => {
                        return (
                            <li
