...
export default function ArticlesPost({ active, title, authors, content, slug }) {
    console.log ("HELLOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO");
    console.log (content.json);
    return (
        <Layout active={-1}>
            <SEO title={"Articles Post"} />
            <div className="w-full md:w-2/3 mt-32 mb-64 mx-auto min-h-full bg-white rounded-md shadow-xl relative z-10">
                <div className="pb-3 lg:pb-0">
                    <h1 className="text-2xl md:text-5xl pl-8 lg:pl-32 pr-8 lg:pr-72 text-center text-black  pt-16 pb-4 md:pb-8 lg:text-left">{title}</h1>
                </div>
                ...
                <p className="italic pb-8 lg:px-32 text-center lg:text-left md:block hidden">{documentToReactComponents(content.json)}</p>
            </div>
